 ...
 */
public class SupermarketNoticeView extends  RecyclerView.Adapter<SupermarketNoticeView.ViewHolder>  {

    private static final String URL_BASE = "http://panambi.town.com:3000/api/supermarkets/3/supermarket_notices.json";
    private static final String TAG = "MunicipalityNoticeView";
    static ListaSupermarketNotice supermarket_notices;
    private static Activity act = null;
    private Map<String, String> headers = new HashMap<String, String>();
    private Context context;
    static ListaSupermarketNotice supermarketnotices;
    ...
    public SupermarketNoticeView(Context context) {
        ...
        MySingleton.getInstance(getContext()).addToRequestQueue(
                new GsonRequest<ListaSupermarketNotice>(
                        URL_BASE,
                        ListaSupermarketNotice.class,
                        headers,
                        new Response.Listener<ListaSupermarketNotice>() {
                            @Override
                            public void onResponse(ListaSupermarketNotice response) {
                                supermarket_notices = response;
                                shpref.guardarSupermarketNotice(supermarket_notices);
                            }
                        },
        ...
        Gson gson = new Gson();
        String json = shpref.getObjetoSupermarketNotice();
        supermarketnotices = gson.fromJson(json, ListaSupermarketNotice.class);

    }

    @Override
    public SupermarketNoticeView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.txtDescription.setText(supermarketnotices.getItems().get(position).getDescription());
        holder.txtTitle.setText(supermarketnotices.getItems().get(position).getTitle());
        String letra = supermarketnotices.getItems().get(position).getTitle();
    ...
    public int getItemCount() {
        ...
        return supermarketnotices  != null ? supermarketnotices.getItems().size() : 0;
    }
